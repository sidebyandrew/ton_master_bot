...
export function bind_command(bot: Bot<MyContext>) {
  ...
  const menu_NFT = new Menu("menu_NFT")
  ...
  const menu_cex = new Menu("menu_cex")
    .url(
  ...
  const menu_bridges = new Menu("menu_bridges")
  ...
  const menu_groups = new Menu("menu_groups")
  ...
  const menu_channels = new Menu("menu_channels")
  ...
  const menu_gambling = new Menu("menu_gambling")
  ...
  const menu_launchpad = new Menu("menu_launchpad")
  ...
  const menu_devtools = new Menu("menu_devtools")
